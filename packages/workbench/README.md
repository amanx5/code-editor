...
### Option 1 — Tailwind CSS users

Use this option if your application already uses Tailwind CSS.

#### Requirements
- Tailwind CSS v3+
- Add the Code Workbench Tailwind preset
- Allow Tailwind to scan the Code Workbench package files

#### Setup

```js
// tailwind.config.cjs
const {presets} = require('code-workbench/tailwind-config');
...
module.exports = {
  ...
  content: [
    './src/**/*.{js,ts,jsx,tsx}',
    './node_modules/code-workbench/**/*.{js,ts,jsx,tsx}',
  ],
};
```
